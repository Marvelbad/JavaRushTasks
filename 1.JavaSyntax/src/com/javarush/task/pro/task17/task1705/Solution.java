...
public class Solution {
    ...
    public static void runWorkingProcess() {
        for (Astronaut astroType : astronauts) {
            if (astroType instanceof Human) {
                pilot((Human) astroType);
            } else if (astroType instanceof Dog) {
                createDirection((Dog) astroType);
            } else if (astroType instanceof Cat) {
                research((Cat) astroType);
            } else {
                System.out.println(astroType.getInfo());
            }
        }
    }
